    ...
    return {
        ...
        "architecture": {"currentVersionId": "ARCH-V00", "targetVersionId": None, "baselines": [],
                         "layers": [{"id": "LAYER-UNASSIGNED", "name": "未分配", "order": 0,
                                     "summary": "仅为归属尚未获得充分证据的模块提供草稿位置。",
                                     "kind": "layer", "extensions": {"layerSemantics": {
                                         "formatVersion": "panorama-layer-semantics.v0.1",
                                         "boundaryType": "unassigned", "rationale": "项目架构尚未定义。",
                                         "inScope": ["归层证据不足的候选模块"], "outOfScope": [],
                                         "evidenceReferenceIds": [], "confidence": "unknown"}}}],
