...
- Event Store 必须完整有效且 Head=current；Sequence 只表示 Actor → Subject 工程动作；Lifecycle 只接受
  Adapter 显式 before/after；Evolution/Risk 只使用 Event Hash Chain 与有界 outcome 强调；
